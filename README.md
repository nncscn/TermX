...
[![Free](https://img.shields.io/badge/%E4%B8%AA%E4%BA%BA%E6%B0%B8%E4%B9%85%E5%85%8D%E8%B4%B9-success?style=flat-square)](#永久免费)
...
[官网](https://termx.cn/) · [下载最新版](../../releases) · [个人永久免费](#永久免费) · [QQ 群 1095707034](#社区)
...
键盘驱动的快速操作入口。模糊搜索、键盘导航，所有操作不用鼠标点击。
...
TermX 承诺：**个人使用永久免费**。无功能限制、无广告、无内购、无使用时间限制。

| 使用场景 | 价格 |
|---------|------|
| 个人学习、日常运维、教育用途 | **永久免费** |
| 企业商用、团队批量部署、定制集成 | 联系商务 |

**我们对免费的理解：**

- **不打广告** — 界面纯净，零商业打扰，专注运维体验
- **不卖数据** — 你的服务器凭据、命令历史、文件内容均存储在本地，绝不上传到任何服务器
- **不锁核心功能** — 终端、监控、SFTP、片段、多服务器管理全部免费可用
- **不强制注册** — 下载即用，无需注册账号

> 企业版咨询、批量授权、定制功能开发，请访问 [官网](https://termx.cn/) 联系商务。
...
| **分屏** | `Ctrl+P` → 「水平分割」/「垂直分割」 |
| **保存命令片段** | 底部状态栏「+ 管理」打开片段管理面板 |
| **快捷键速查** | `Ctrl+P` 打开命令面板，所有快捷键可达 |
